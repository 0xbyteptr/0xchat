...
export default function ChatHeader({ server, selectedChannel, onShowOverview }: ChatHeaderProps) {
  return (
    <div className="border-b border-slate-700/50 px-8 py-5 bg-slate-800/40 backdrop-blur-md flex items-center justify-between sticky top-0 z-10">
